...
# 2. Service Cards (Target ~5-7 KiB each at crystal clear quality 58)
optimize_image_from_source("fuga-gas.webp", source_name="fuga-gas.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("fuga_gas_detection_1786655758341.webp", source_name="fuga-gas.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("prodoral.webp", source_name="prodoral.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("prodoral_technology_1786655847004.webp", source_name="prodoral.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("calefont.webp", source_name="calefont.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("calefont_service_1786655948959.webp", source_name="calefont.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("hero-sec.webp", source_name="hero-sec.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("hero-destapes.webp", source_name="hero-destapes.png", max_width=380, max_height=214, quality=58)
optimize_image_from_source("hero-gasfiter.webp", source_name="hero-gasfiter.png", max_width=380, max_height=214, quality=58)
