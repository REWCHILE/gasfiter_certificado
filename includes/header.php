...
<body>
  ...
  <header class="header-main" id="header-main">
    <div class="container navbar-container">
      <!-- Brand Logo & Identity -->
      <a href="index.php" class="brand-logo-link" aria-label="Gásfiter Certificado - Volver al Inicio">
        <img src="assets/images/logo.jpg" alt="Logotipo Gásfiter Certificado SEC" class="brand-logo-img" width="48" height="48">
      ...
      <nav class="desktop-nav" aria-label="Menú Principal">
        <ul class="nav-menu-desktop">
          ...
          <li class="nav-item">
            <a href="fuga-de-gas.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'fuga-de-gas.php') ? 'active' : ''; ?>">
              Fugas de Gas
          ...
          <li class="nav-item">
            <a href="prodoral.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'prodoral.php') ? 'active' : ''; ?>">Sin Picar (Prodoral)</a>
          </li>

          <li class="nav-item">
            <a href="cobertura.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'cobertura.php') ? 'active' : ''; ?>">Cobertura RM</a>
          </li>

          <li class="nav-item">
            <a href="cotizar.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'cotizar.php') ? 'active' : ''; ?>">Cotizador Online</a>
          </li>
