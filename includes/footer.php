    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <div class="footer-heading" role="heading" aria-level="3">Servicios SEC</div>
        ...
        <div class="footer-col">
          <div class="footer-heading" role="heading" aria-level="3">Cobertura Santiago</div>
          <ul class="footer-links">
        ...
        <div class="footer-col">
          <div class="footer-heading" role="heading" aria-level="3">Central de Atención</div>
