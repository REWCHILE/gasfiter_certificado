...
<main>
  ...
  <section class="hero-section" style="padding: 3.5rem 0 4rem;">
    <div class="container" style="text-align: center; max-width: 860px;">
      <span class="hero-badge-live">Servicios Integrales a Domicilio</span>
      <h1 class="hero-title" style="font-size: 2.8rem;">
        Catálogo de Servicios de <span class="highlight-gold">Gásfiter Certificado SEC</span>
      </h1>
      <p class="hero-lead">
        Todas nuestras intervenciones cuentan con respaldo técnico acreditado ante la SEC, boleta o factura electrónica y certificado formal de garantía.
      </p>
      ...
      <div class="services-grid">
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            <h2 class="service-title">Detección y Reparación de Fugas de Gas</h2>
            <p class="service-text">Ubicación exacta con detectores digitales de alta sensibilidad y geófonos. Pruebas de hermeticidad certificadas y reposición del suministro.</p>
            <ul class="service-bullets">
              <li>✔️ Redes de Gas Natural y Gas Licuado GLP</li>
              <li>✔️ Protocolo normado SEC DS 66</li>
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            ...
            <ul class="service-bullets">
              ...
              <li>✔️ Garantía extendida de 5 años</li>
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            <h2 class="service-title">Certificación Sello Verde SEC & TC6</h2>
            <p class="service-text">Inspecciones periódicas, levantamiento de sellos rojos/amarillos y regularización integral de redes de gas para casas y edificios.</p>
            <ul class="service-bullets">
              <li>✔️ Declaración TC6 digital ante la SEC</li>
              <li>✔️ Planos isométricos y memorias técnicas</li>
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            <h2 class="service-title">Mantención y Reparación de Calefont</h2>
            <p class="service-text">Servicio técnico autorizado para Junkers, Splendid, Mademsa, Trotter, Neckar y calderas murales con repuestos legítimos.</p>
            <ul class="service-bullets">
              <li>✔️ Solución a problemas de encendido, chispa y apagado</li>
              <li>✔️ Desincrustación y limpieza de serpentín</li>
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            <h2 class="service-title">Destape de Cañerías y Alcantarillado</h2>
            <p class="service-text">Desobstrucción de redes sanitarias, WC, tinas, lavaplatos y cámaras con máquinas rotativas K-50 y K-60 sin dañar tuberías.</p>
            <ul class="service-bullets">
              <li>✔️ Inspección con videocámara CCTV</li>
              <li>✔️ Eliminación de sarro, raíces y grasas</li>
        ...
        <article class="service-card">
          ...
          <div class="service-body">
            <h2 class="service-title">Gasfitería General e Instalaciones</h2>
            <p class="service-text">Instalación de bombas hidroneumáticas, termos eléctricos, llaves de paso, griferías y reparación de filtraciones de agua potable.</p>
            <ul class="service-bullets">
              <li>✔️ Cañerías de cobre, PPR y PEX</li>
              <li>✔️ Reductoras de presión y estanques</li>
